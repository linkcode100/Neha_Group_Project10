...
@WebServlet("/microloan")
public class MicroLoan extends HttpServlet {
...
//		out.println(upan);
		try {
		    ...
		    PreparedStatement pspt=con.prepareStatement("insert into micro(ufullname,uemail,ugender,uemptype,uyearincome,ucomname,uaddtype,unationality,ustate,uloanamt,utime,upan) "
		    		+ "values(?,?,?,?,?,?,?,?,?,?,?,?)");
