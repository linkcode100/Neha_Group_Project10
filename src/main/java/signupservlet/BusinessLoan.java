...
@WebServlet("/businessloan")
public class BusinessLoan extends HttpServlet {
...
//		out.println(upan);
		try {
		    ...
		    PreparedStatement pspt=con.prepareStatement("insert into business(ufullname,uemail,ugender,uemptype,uyearincome,ucomname,uaddtype,unationality,ustate,uloanamt,utime,upan) "
		    		+ "values(?,?,?,?,?,?,?,?,?,?,?,?)");
