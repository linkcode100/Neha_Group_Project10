...
@WebServlet("/loanagainst")
public class LoanAgainst extends HttpServlet {
...
//		out.println(upan);
		try {
		    ...
		    PreparedStatement pspt=con.prepareStatement("insert into loanagainst(ufullname,uemail,ugender,uemptype,uyearincome,ucomname,uaddtype,unationality,ustate,uloanamt,utime,upan) "
		    		+ "values(?,?,?,?,?,?,?,?,?,?,?,?)");
