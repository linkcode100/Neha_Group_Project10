...
//		out.println(upan);
		try {
		    ...
		    PreparedStatement pspt=con.prepareStatement("insert into personal(ufullname,uemail,ugender,uemptype,uyearincome,ucomname,uaddtype,unationality,ustate,uloanamt,utime,upan) "
		    		+ "values(?,?,?,?,?,?,?,?,?,?,?,?)");
