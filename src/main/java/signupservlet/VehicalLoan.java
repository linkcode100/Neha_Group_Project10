...
@WebServlet("/vehicalloan")
public class VehicalLoan extends HttpServlet {
...
//		out.println(upan);
		try {
		    ...
		    PreparedStatement pspt=con.prepareStatement("insert into vehical(ufullname,uemail,ugender,uemptype,uyearincome,ucomname,uaddtype,unationality,ustate,uloanamt,utime,upan) "
		    		+ "values(?,?,?,?,?,?,?,?,?,?,?,?)");
